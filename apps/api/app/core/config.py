...
class Settings(BaseSettings):
    ...
    DEMO_RECONCILIATION_LOOKBACK_HOURS: int = 24
    DEMO_RECONCILIATION_MAX_ATTEMPTS_PER_RUN: int = 10
    DEMO_RECONCILIATION_HISTORY_LIMIT: int = 50
    DEMO_RECONCILIATION_SCHEDULER_ENABLED: bool = False
    DEMO_RECONCILIATION_SCHEDULER_INTERVAL_SECONDS: int = 120
    DEMO_RECONCILIATION_SCHEDULER_INITIAL_DELAY_SECONDS: int = 10
    DEMO_RECONCILIATION_SCHEDULER_BACKOFF_SECONDS: int = 300
    DEMO_RECONCILIATION_SCHEDULER_MAX_RUNTIME_SECONDS: int = 60
    DEMO_RECONCILIATION_SCHEDULER_RUN_ON_STARTUP: bool = False
    DEMO_RECONCILIATION_SCHEDULER_LOCK_TTL_SECONDS: int = 90
